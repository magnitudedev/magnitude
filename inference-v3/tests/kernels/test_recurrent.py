...
from magnitude_engine.kernels.recurrence.portable import delta_sequence
...
def test_delta_nonzero_state_and_independent_batch_rows(mapping, key_width, value_width, steps):
    ...
    if backend == Backend.METAL:
        from magnitude_engine.kernels.recurrence.channel_simd import delta_sequence as metal_delta
