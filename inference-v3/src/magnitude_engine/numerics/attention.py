"""Causal attention over explicit segments in shared storage, with mergeable statistics.

Each segment has a physical offset, logical start and visible length. Gaps between
segments are never read. Partitioning and grouping do not relocate history.
"""
