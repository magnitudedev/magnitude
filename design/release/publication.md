...
6. Register the accepted GitHub assets in Magnitude's hosted distribution database and sign the
   desktop update manifests. Registration does not copy or stream installer bytes through Vercel.
