...
one complete `TargetProfile` before planning: exact supported intrinsic signatures, quantitative
...
Prepared variants, native artifacts, and numerical evidence bind to module semantic hash,
