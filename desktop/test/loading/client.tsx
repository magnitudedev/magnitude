...
export const useCatalogModels = () => {const value=usePhase();return value === 'loading' ? Result.initial() : value === 'error' ? Result.fail('offline') : Result.success({...modelState,models:page === "models" ? models : models.map(model=>({...model,acquisitionState:{_tag:"NotInstalled"}}))})}
