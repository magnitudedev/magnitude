...
#else
#error "qwen_readout_rows requires a dense norm representation"
#endif
}
...
#else
#error "qwen_readout_rows currently requires dense output weights"
#endif
}
...
#else
#error "qwen_readout_rows requires a dense activation representation"
#endif
}
...
kernel void qwen_readout_rows(
    ...
    ulong width = SEISMIC_DIM_D + SEISMIC_DIM_V;
    ...
    if (lane < SEISMIC_DIM_D) {
        ...
        ulong vocabulary = lane - SEISMIC_DIM_D;
        float sum = 0.0f;
        ...
        logits[offset2(row, vocabulary, SEISMIC_RESULT_1_STRIDE_0, SEISMIC_RESULT_1_STRIDE_1)] = sum;
    }
}
