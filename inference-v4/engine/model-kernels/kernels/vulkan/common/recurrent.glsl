// Shared device code of the Vulkan gated-delta entries (`qwen_recurrent_step`,
// `qwen_recurrent_chunk`; contracts in recurrent.seismic): slot, bank and
...
// `cuda/common/recurrent.cuh`, whose arithmetic it follows.
