...
extern "C" __global__ void qwen_attention_project_stage_s8(SEISMIC_KERNEL_PARAMS) {
...
extern "C" __global__ void qwen_attention_project_gemm_small(SEISMIC_KERNEL_PARAMS) {
