// qwen_attention_decode_k8v4 (M <= 8): `qwen_attention_decode`'s split-KV
...
extern "C" __global__ void __launch_bounds__(WARPS * 32)
    qwen_attention_decode_k8v4_partial(SEISMIC_KERNEL_PARAMS) {
...
extern "C" __global__ void qwen_attention_decode_k8v4_merge(SEISMIC_KERNEL_PARAMS) {
