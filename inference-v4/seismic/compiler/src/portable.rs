...
use crate::implementation::{
    Applicability, FactoryRequest, ImplementationBuilder, ImplementationFactory, ScalarPublication,
    ValueBinding,
};
use crate::refinement::{CandidateFamily, FactoryIdentity};
use seismic_ir::kernel::dynamic::{PortableBuilder, PortableTensor, PortableValue};
...
use seismic_ir::schedule::{AnyScalarSlot, LaunchMode};
...
impl<B: seismic_target::TargetFamily> ImplementationFactory<B> for PortableFactory {
...
impl<B: seismic_target::TargetFamily> ImplementationFactory<B> for PortableParallelFactory {
    fn identity(&self) -> FactoryIdentity {
        FactoryIdentity {
...
impl<B: seismic_target::TargetFamily> ImplementationFactory<B> for AuthoredSemanticFactory {
    fn identity(&self) -> FactoryIdentity {
        FactoryIdentity {
...
fn construct_semantic<'a, B: seismic_target::TargetFamily>(
...
pub(crate) fn realize_tensor<B: seismic_target::TargetFamily>(
