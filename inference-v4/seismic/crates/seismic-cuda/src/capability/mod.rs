...
//! (spec §4.2, §24 R4).
//!
//! `CudaIntrinsic` is `Backend::Intrinsic`: the only backend operations
...
use crate::factory;
use crate::Cuda;
use seismic_compiler::kernel::ops::{AddressableResourceHandle, LogicalTensorMap};
use seismic_compiler::target::{
    CapabilityRegistration, CapabilityRegistry, DataTypeSupport, TargetLimits,
};
...
fn assemble() -> CapabilityRegistry<Cuda> {
