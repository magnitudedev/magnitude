...
use crate::{Metal, MetalBuffer, MetalDevice, MetalLaunchMode};
...
impl NativeSubmission<Metal> for MetalSubmission {
    ...
    fn execute(
        ...
        env: &mut ExecutionEnvironment<'_, Metal, MetalDevice>,
...
impl MetalSubmission {
    ...
    fn copy(
        ...
        bytes: u64,
        env: &ExecutionEnvironment<'_, Metal, MetalDevice>,
    ) -> Result<(), ExecutionError> {
...
fn scratch_buffer<'a>(
    ...
    env: &'a ExecutionEnvironment<'_, Metal, MetalDevice>,
