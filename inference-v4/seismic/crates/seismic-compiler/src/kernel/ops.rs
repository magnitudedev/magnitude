...
pub enum ClosedOpView<'a, B: Backend> {
    Constant {
        out: ClosedValue,
        value: ConstantValue,
    },
...
pub struct IntrinsicSink<'a, B: Backend> {
...
pub struct SemanticScalar {
    ...
    /// schedule slot.
    pub uniformity: seismic_lang::registry::IntrinsicUniformity,
}
...
/// operand. Backend intrinsic variants may retain this closed map and apply
...
pub struct SemanticIntrinsicSink<'s, 'k, B: Backend> {
