...
import { buildIcnBinary } from "../inference/scripts/build-binary";
...
async function verifyTarball(
  ...
  if (
    ...
    throw new Error(
      `[release] ${basename(path)} contains ${JSON.stringify(
        listing
