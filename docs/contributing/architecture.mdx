...
Agent Core (packages/agent/)
  Orchestrator + subagents, execution manager, tools, projections integration
  ↓ uses
...
- **Orchestrator**: user-facing coordinator; manages delegation and conversation.
- **Scout**: fast reconnaissance and codebase orientation.
