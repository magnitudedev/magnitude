...
Web search is available to the lead agent, explorers, planners, builders, and debuggers.

## Provider routing

Web search is routed through your lead agent's provider using their native search capabilities:
