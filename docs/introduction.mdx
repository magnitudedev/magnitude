...
<img className="hidden dark:block" src="/ecosystem-dark.png" alt="Your existing agent connected to Magnitude, which runs local models for your machine." />
<img className="block dark:hidden" src="/ecosystem-light.png" alt="Your existing agent connected to Magnitude, which runs local models for your machine." />
