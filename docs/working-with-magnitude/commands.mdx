...
You can paste images from your clipboard or paste image file paths to attach them. Large text pastes (over 1000 characters) are automatically collapsed into paste segments.