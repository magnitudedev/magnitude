...
Any app that lets you set a custom base URL can use Magnitude on this computer. For an app or agent on another device, in a container, or inside WSL, see [Network access](/api/network-access).
