...
Yes. Turn on **Network access** in Settings and use the address and API key it shows. Only inference is available from other devices. See [Other devices](/api/other-devices) and [Windows and WSL](/api/windows-wsl).
