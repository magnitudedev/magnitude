...
| `magnitude connections add <harness> [--set-current <model-id>] [--install-skill]` | Connect installed models and optionally select a model and refresh the harness skill |
