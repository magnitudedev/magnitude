...
export const interactiveLaunchOptions = (
...
export const runInteractive = (opts: InteractiveCommandOptions, setup: boolean) =>
  Effect.runPromise(runInteractiveCommand(interactiveLaunchOptions(opts, setup)).pipe(
