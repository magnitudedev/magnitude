...
export const piDevelopmentConnectionOptions = (root: string): HarnessConnectionOptions & { paths: HarnessConnectionPaths } => {
  ...
  return {
    paths,
    registry: makeHarnessConnectorRegistry(paths, { piCompanionSource: resolve(import.meta.dir, "../../../integrations/pi") }),
    // The development launcher already owns service startup and restoration.
