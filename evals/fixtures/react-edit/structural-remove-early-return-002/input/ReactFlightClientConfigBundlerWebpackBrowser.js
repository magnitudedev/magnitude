...
import type { ReactDebugInfo, ReactIOInfo, ReactAsyncInfo } from 'shared/ReactTypes';
...
const chunkIOInfoCache: Map<string, ReactIOInfo> = __DEV__ ? new Map() : (null: any);

export function addChunkDebugInfo(target: ReactDebugInfo, chunkId: string, filename: string): void {
  if (!__DEV__) {
    return;
  }
