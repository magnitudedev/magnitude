...
export function prerender(model: ReactClientValue, options?: Options): Promise<StaticResult> {
...
export function decodeReplyFromAsyncIterable<T>(
  ...
  const iterator: AsyncIterator<[string, string | File]> = iterable[ASYNC_ITERATOR]();
