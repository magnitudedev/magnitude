...
import type { Element, HookNames } from 'react-devtools-shared/src/frontend/types';
        ...
        loadHookNamesFunction(hooksTree, fetchFileWithCaching).then(
          function onSuccess(hookNames) {
            ...
            if (hookNames) {
              ...
              const notFoundThenable: RejectedThenable<HookNames> = (thenable: any);
          ...
          function onError(error) {
            ...
            const rejectedThenable: RejectedThenable<HookNames> = (thenable: any);
