...
import type { ImportMetadata, ImportManifestEntry } from '../shared/ReactFlightImportMetadata';
import type { ModuleLoading } from 'react-client/src/ReactFlightClientConfig';

import { ID, CHUNKS, NAME, isAsyncImport } from '../shared/ReactFlightImportMetadata';

import { prepareDestinationWithChunks } from 'react-client/src/ReactFlightClientConfig';

import { loadChunk, addChunkDebugInfo } from 'react-client/src/ReactFlightClientConfig';
...
export function preloadModule<T>(metadata: ClientReference<T>): null | Thenable<any> {
...
export function getModuleDebugInfo<T>(metadata: ClientReference<T>): null | ReactDebugInfo {
  if (!__DEV__) {
    return null;
  }
  const chunks = metadata[CHUNKS];
