...
import type { Container, ActivityInstance, SuspenseInstance } from '../client/ReactFiberConfigDOM';
...
function dispatchDiscreteEvent(
  ...
  try {
    ...
    dispatchEvent(eventSystemFlags, domEventName, container, nativeEvent);
  } finally {
