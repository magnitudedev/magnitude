...
function getNativeBeforeInputChars(domEventName: DOMEventName, nativeEvent: any): ?string {
  switch (domEventName) {
    case 'compositionend':
 ...
 */
function getFallbackBeforeInputChars(domEventName: DOMEventName, nativeEvent: any): ?string {
