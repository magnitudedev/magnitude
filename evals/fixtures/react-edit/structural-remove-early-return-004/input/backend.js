...
export function initialize(
  ...
  const componentFiltersOrComponentFiltersPromise = maybeComponentFiltersOrComponentFiltersPromise
    ? maybeComponentFiltersOrComponentFiltersPromise
...
export function connectToDevTools(options: ?ConnectOptions) {
  ...
  function handleMessage(event: MessageEvent<>) {
    ...
    try {
      ...
      console.error('[React DevTools] Failed to parse JSON: ' + (event.data: any));
      return;
    }
