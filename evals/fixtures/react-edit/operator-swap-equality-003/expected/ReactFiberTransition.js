...
import type { Thenable, GestureProvider, GestureOptions } from 'shared/ReactTypes';
...
if (enableGestureTransition) {
  ...
  ReactSharedInternals.G = function onStartGestureTransitionFinishForReconciler(
    ...
    let root = firstScheduledRoot;
    while (root !== null) {
      const scheduledGesture = startScheduledGesture(root, provider, options, transition.types);
      if (scheduledGesture !== null) {
