...
export function parseStackTracePrivate(error: Error, skipFrames: number): null | ReactStackTrace {
...
export function parseStackTrace(error: Error, skipFrames: number): ReactStackTrace {
