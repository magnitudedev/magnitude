...
function FunctionLocation({ location, displayName }: FunctionLocationProps) {
  ...
  return (
    <li>
      <Button
        className={canViewSource ? styles.ClickableSource : styles.UnclickableSource}
        ...
        <ul className={styles.List}>
          ...
          {componentStack && (
            <li className={styles.ListItem}>
              ...
              <ul className={styles.List}>
                {stackToComponentLocations(componentStack).map(([displayName, location], index) => {
                  if (location == null) {
                    return (
                      <li key={index}>
                        <Button className={styles.UnclickableSource} disabled={true}>
                          {displayName}
                        </Button>
                      </li>
                    );
                  ...
                  return (
                    <FunctionLocation key={index} displayName={displayName} location={location} />
                  );
                })}
              </ul>
            </li>
