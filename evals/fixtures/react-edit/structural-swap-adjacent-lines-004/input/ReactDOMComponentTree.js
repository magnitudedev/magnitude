...
import type { ReactDOMEventHandle, ReactDOMEventHandleListener } from './ReactDOMEventHandleTypes';
import type {
  Container,
  TextInstance,
  Instance,
...
const internalInstanceMap: WeakMap<InstanceUnion, Fiber> | Map<InstanceUnion, Fiber> =
  new PossiblyWeakMap();
const internalPropsMap: WeakMap<InstanceUnion, Props> | Map<InstanceUnion, Props> =
  new PossiblyWeakMap();
...
export function precacheFiberNode(
  hostInst: Fiber,
  node: Instance | TextInstance | SuspenseInstance | ActivityInstance | ReactScopeInstance,
): void {
  if (enableInternalInstanceMap) {
...
export function getFiberCurrentPropsFromNode(
  node: Container | Instance | TextInstance | SuspenseInstance | ActivityInstance,
): Props | null {
  if (enableInternalInstanceMap) {
...
export function getEventListenerSet(node: EventTarget): Set<string> {
  let elementListenerSet: Set<string> | void = (node: any)[internalEventHandlersKey];
