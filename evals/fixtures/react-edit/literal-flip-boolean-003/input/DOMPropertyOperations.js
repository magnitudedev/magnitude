 ...
 */
export function getValueForAttribute(node: Element, name: string, expected: mixed): mixed {
  if (__DEV__) {
...
export function setValueForAttribute(node: Element, name: string, value: mixed) {
  if (isAttributeNameSafe(name)) {
    ...
    node.setAttribute(name, enableTrustedTypesIntegration ? (value: any) : '' + (value: any));
  }
}

export function setValueForKnownAttribute(node: Element, name: string, value: mixed) {
  if (value === null) {
    node.removeAttribute(name);
    return;
  }
...
export function setValueForPropertyOnCustomComponent(node: Element, name: string, value: mixed) {
