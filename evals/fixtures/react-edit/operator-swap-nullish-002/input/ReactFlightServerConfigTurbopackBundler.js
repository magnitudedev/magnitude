...
import type { ClientReference, ServerReference } from '../ReactFlightTurbopackReferences';
...
export { isClientReference, isServerReference } from '../ReactFlightTurbopackReferences';

export function getClientReferenceKey(reference: ClientReference<any>): ClientReferenceKey {
