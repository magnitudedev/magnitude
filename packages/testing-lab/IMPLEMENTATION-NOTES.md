...
These notes preserve successive implementation checkpoints, including superseded failures and
limitations. They are not the current status or supported usage contract. Use [USAGE.md](USAGE.md)
for commands and [COVERAGE.md](COVERAGE.md) for current qualification.
