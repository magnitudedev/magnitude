...
import { WorkAssignment, WorkClaim, TargetResult } from "./work-store"
...
export const WorkerReply = Schema.Struct({ schemaVersion: Schema.Literal(1), claim: WorkClaim, result: TargetResult })
