...
export const SshMachine = Schema.Struct({ provider: Schema.Literal("spark"), host: Schema.NonEmptyString, containerId: Schema.String.pipe(Schema.pattern(/^[a-f0-9]{64}$/)), tags: MachineTags })
