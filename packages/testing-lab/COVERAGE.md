...
handoff is deployed in coordinator v19; the new Mac run completed input handoff and started native Cargo/Clang compilation. Full packaged-app qualification remains active. The first image build caught missing archive tools; the final image explicitly installs tar and gzip and built successfully.

Active v19 rechecks: Mac CPU `run-28029673-9f0c-4d23-9e19-f6a3435ff131` and Red Hat ARM app `run-ba4c97ab-766a-42d7-9c6b-8098ca18b155`. These are active runs, not passing qualification. Ubuntu/Debian ARM package recheck `run-f4cdd4e6-7649-4fd0-a93e-fc647374b5c8` completed 16/16 checks with verified evidence and no resources remaining.
