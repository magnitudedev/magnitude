...
export type MessageBodyFrame = { readonly _tag: 'MessageBody'; id: string; dest: string; artifactsRaw: string | null; body: string; pendingLt: boolean; depth: number; pendingNewlines: number }
export type MessageOpenPrefixMatchFrame = { readonly _tag: 'MessageOpenPrefixMatch'; id: string; dest: string; artifactsRaw: string | null; body: string; depth: number; pendingNewlines: number; prefix: PrefixMatch }
export type MessageClosePrefixMatchFrame = { readonly _tag: 'MessageClosePrefixMatch'; id: string; dest: string; artifactsRaw: string | null; body: string; depth: number; pendingNewlines: number; prefix: PrefixMatch }
export type MessageOpenTagTailFrame = { readonly _tag: 'MessageOpenTagTail'; id: string; dest: string; artifactsRaw: string | null; body: string; depth: number; pendingNewlines: number; raw: string; selfClosing: boolean }
