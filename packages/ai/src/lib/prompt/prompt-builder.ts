...
import { Prompt, type PromptShape } from "./prompt"
...
export class PromptBuilder<Messages extends readonly Message[] = readonly []> {
  ...
  build(this: PromptBuilder<readonly [...readonly Message[], UserMessage | ToolResultMessage]>): PromptShape {
    return Prompt.from(this.messages, this.systemParts)
  }
}
