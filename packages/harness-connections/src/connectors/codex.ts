...
const codexProviderTable = (baseUrl: string) => `[model_providers.${CODEX_PROVIDER_ID}]
name = "OpenAI"
...
export const makeCodexConnector = (
  ...
  connect: (spec) => Effect.gen(function* () {
    ...
    next = installMagnitudeProvider(next, baseUrl)
