...
const CONTEXTS = [64_000, 100_000, 200_000] as const
...
export const LOCAL_MODEL_CATALOG: readonly LocalModelCatalogEntry[] = [
  ...
  entry({ id: "gemma-4-e2b-it-qat", family: "gemma-4", displayName: "Gemma 4 E2B", repo: "unsloth/gemma-4-E2B-it-qat-GGUF", revision: "2ea637031baa8dc847d64b5dbb7011fd6a445849", primaryGguf: "gemma-4-E2B-it-qat-UD-Q4_K_XL.gguf", quantTag: "UD-Q4_K_XL", quality: 8, quantAware: true, contexts: [64_000, 100_000] }),
