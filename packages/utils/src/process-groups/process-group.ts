 ...
 * lives in `./exact-process` (`@magnitudedev/utils/process-groups/native`).
 */
...
export interface ProcessGroupController {
  ...
  readonly stop: (
    group: ProcessGroup,
    timing?: { readonly termWait: Duration.DurationInput; readonly killWait: Duration.DurationInput },
...
export const ProcessGroupController = Context.GenericTag<ProcessGroupController>(
  "@magnitudedev/utils/ProcessGroupController",
)
