...
export const MagnitudeRpcs = RpcGroup.make(
  ...
  LocalInference.IcnHardwareMirror.getRpc.middleware(AcnRpcCommandActivity),
  LocalInference.IcnInventoryMirror.getRpc.middleware(AcnRpcCommandActivity),
  LocalInference.ModelRecipesMirror.getRpc.middleware(AcnRpcCommandActivity),
