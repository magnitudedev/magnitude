...
const AcnDemandRpcs = RpcGroup.make(
  ...
  LocalInference.DownloadCatalogModel,
  LocalInference.CancelCatalogModelDownload,
  LocalInference.DeleteCatalogModel,
  LocalInference.SelectCatalogModel,
  ...
  Onboarding.ClearOnboardingLocalModelSelection,
  Files.ListFiles,
  Files.ReadFile,
