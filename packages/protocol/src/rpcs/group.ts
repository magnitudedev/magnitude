...
const AcnDemandRpcs = RpcGroup.make(
  ...
  Config.UpdateModelSlot,
  Config.GetCloudUsage,
  LocalInference.LocalInferenceHardwareMirror.getRpc,
  LocalInference.LocalModelInventoryMirror.getRpc,
  LocalInference.DownloadLocalModel,
  LocalInference.DeleteLocalModel,
  LocalInference.LoadModelSlot,
  LocalInference.ReloadModelSlot,
  LocalInference.UnloadModelSlot,
