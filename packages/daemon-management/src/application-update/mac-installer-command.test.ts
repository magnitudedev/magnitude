...
const request = { protocol: 1, bundle: "/Applications/Magnitude.app", stateDirectory: "/Users/test/.magnitude/state",
...
describe("macOS private installer invocation", () => {
  ...
  it.each([
    { ...request, protocol: 2 }, { ...request, bundle: "/Applications/../Magnitude.app" },
