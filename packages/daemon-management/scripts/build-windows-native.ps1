...
try {
  ...
  & link.exe /nologo /DLL /MACHINE:X64 /DELAYLOAD:node.exe "/OUT:$Output" `
    desktop-host.obj windows-job.obj windows-job-napi.obj windows-security.obj windows-process-napi.obj windows-pipe.obj windows-pipe-napi.obj windows-delay-load.obj $NodeLibrary delayimp.lib advapi32.lib shell32.lib ole32.lib user32.lib
