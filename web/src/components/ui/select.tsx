  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none flex size-4 shrink-0 items-center justify-center">
        <SelectPrimitive.ItemIndicator><CheckIcon className="pointer-events-none size-4" /></SelectPrimitive.ItemIndicator>
      </span>
    </SelectPrimitive.Item>
  )
}
